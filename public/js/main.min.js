...
$.extend($.easing, {
    ...
    (Riode.headerToggleSearch = function(e) {
        ...
        t
            ...
            Riode.$body.on("click", ".sticky-footer .search-toggle", function(
                e
            ) {
                $(this)
                    .parent()
                ...
                a = function() {
                    if (
                        ...
                        t.find(".category-dropdown .dropdown-box").length &&
                            (o += t.find(".category-dropdown .dropdown-box")[0]
                                .offsetHeight);
                    }
                    !n &&
                        window.innerWidth >=
                                ...
                                window.innerWidth <= o.maxWidth
                                    ? (t.hasClass("fix-top")
                                          ? (void 0 === t.data("offset-top") &&
                                            ...
                                            t.css(
                                                "margin-top",
                                                t.data("offset-top") + "px"
                                            ))
                                          : t.hasClass("fix-bottom") &&
                                            (void 0 ===
                                                t.data("offset-bottom") &&
                                                (function(e) {
                                                    var t = 0,
                                                        i = 0;
                                                    $(
        ...
        for (
            var t = Riode.byClass("ratings-full", e || document.body),
                ...
                o = function() {
                    var e =
                        parseInt(
                            this.firstElementChild.style.width.slice(0, -1)
                        ) / 20;
    ...
    (Riode.initPopups = function() {
        Riode.$body
            ...
            .on("click", "a.login, .notification-link", function(e) {
                e.preventDefault(),
                    Riode.popup(
                        { items: { src: $(e.currentTarget).attr("href") } },
                        "login"
        ...
        return (
            (e.prototype.init = function(e) {
                ...
                (a.$wrapper = e),
                    ...
                    (a._isPgvertical = !1),
                    a.isQuickview &&
                        ((n = n.bind(this)), Riode.ratingTooltip()),
                    s
                            ...
                            a.isQuickview ||
                                ...
                                (function(e) {
                                    (e.$thumbs = e.$wrapper.find(
                                        ...
                                        (e.$thumbUp = e.$thumbsWrap.find(
                                            ".thumb-up"
                                        )),
                                        (e.$thumbDown = e.$thumbsWrap.find(
                                            ".thumb-down"
                                        )),
                        ...
                        .on("translate.owl.carousel", function(e) {
                            var t =
                                (e.item.index -
                                    $(e.currentTarget).find(".cloned").length /
                                        2 +
                                    e.item.count) %
                                e.item.count;
                            a.thumbsSetActive(t);
                            ...
                            (i.closest(".product-popup").length ||
                                ...
                                Riode.Minipopup.open({
                                    ...
                                    imageLink: i
                                        ...
                                        .attr("href"),
                                    price:
                                        i.find(".product-variation-price")
                                            .length > 0
                                            ? i
                                                  .find(
                                                      ".product-variation-price"
                                    ...
                                    actionTemplate:
                                        '<div class="action-group d-flex mt-3"><a href="/cart" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2">View Cart</a><a href="/checkoutMart" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>'
                                });
                        });
                    })(this);
            }),
            (e.prototype.thumbsSetActive = function(e) {
                ...
                if (
                    ...
                    var i =
                        parseInt(this.$thumbs.css("top")) +
                        e * this.thumbsHeight;
                    i < 0
                        ? this.$thumbs.css(
                              "top",
                              parseInt(this.$thumbs.css("top")) - i
                          )
                        : (i =
            ...
            if (
                ...
                var o = t
                    ...
                    n = i
                        ...
                        .data("owl.carousel"),
                    a = n
                        ? (n.current() - n.clones().length / 2 + o.length) %
                          o.length
    ...
    (Riode.slider = (function() {
        ...
        return (
            ...
            (Riode.defaults.sliderPresets[
                ...
                "product-gallery-carousel"
            ].onInitialized = e.zoomImage),
            (Riode.defaults.sliderPresets[
                "product-single-carousel"
            ].onRefreshed = Riode.defaults.sliderPresets[
                "product-gallery-carousel"
            ].onRefreshed = e.zoomImageRefresh),
            ...
            (e.prototype.startIncrease = function(e) {
                ...
                (t.value = t.$value.val()),
                    ...
                    (t.increaseTimer = Riode.requestTimeout(function() {
                        (t.speed = 1),
                            (t.increaseTimer = Riode.requestInterval(
                                function() {
                                    t.$value.val(
                                        (t.value = Math.min(
                                            t.value +
                                                Math.floor((t.speed *= 1.05)),
                                            t.max
                                        ))
                                    );
                                },
            ...
            (e.prototype.startDecrease = function() {
                ...
                (e.value = e.$value.val()),
                    ...
                    (e.decreaseTimer = Riode.requestTimeout(function() {
                        (e.speed = 1),
                            (e.decreaseTimer = Riode.requestInterval(
                                function() {
                                    e.$value.val(
                                        (e.value = Math.max(
                                            e.value -
    ...
    (Riode.floatSVG = (function() {
        ...
        return (
            ...
            (e.prototype.getDeltaY = function(e) {
                return (
                    Math.sin(
                        ((2 * Math.PI * e) / this.width) * this.options.size
                    ) * this.options.delta
                );
            }),
            ...
            (e.prototype.draw = function() {
                var e = this,
                    t =
                        ((Date.now() - this.timeStart) * this.options.speed) /
                        200;
                            ...
                            Riode.Minipopup.open({
                                ...
                                count:
                                    t.find(".quantity").length > 0
                                        ...
                                        : 1,
                                actionTemplate:
                                    '<div class="action-group d-flex"><a href="cart" class="btn btn-sm btn-outline btn-primary btn-rounded">View Cart</a><a href="checkoutMart" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>'
                            });
                    }
                );
        },
