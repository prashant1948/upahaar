...
<main class="main checkout pb-10 bg-additional">
										...
										<table class="order-table">
											...
											@foreach ($products as $product)
												...
												<tr>
													...
													<td class="product-total text-body">{{$product->rate}}</td>
												</tr>
		...
		<!-- <script>
				function fnTotal(a,b) {
					var c = a+b;
					alert(c);
					document.getElementById("totalsum").innerHTML = c;
				}
        ...
        <script>
            ...
            var checkBox = document.getElementById("different-address");
            var data = document.getElementById("data-shipping");
